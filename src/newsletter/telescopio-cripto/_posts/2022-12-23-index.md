      ...
      - include: telescopio_v1_titulo_tracinho.html
        data:
          ...
          text: >-
            ...
            Ainda assim, vale ressaltar que o índice S&P500 se encaminha para encerrar a terceira semana consecutiva em queda, reagindo negativamente após testar importante região de resistência e seguir negociando em tendência de baixa.

            <br />

            Este é um ponto de atenção para os investidores de criptomoedas, uma vez que a correlação entre o Bitcoin e o índice S&P500 se mostrou elevada durante todo o ano de 2022, podendo seguir pressionando as cotações.

            <br />

            Porém o Bitcoin ainda precisa fazer seu "dever de casa" e superar a importante região dos US$18.000, que se estabeleceu como principal resistência aos preços, para retomar sua tendência de alta.
      - include: telescopio_v1_imagem.html
        data:
