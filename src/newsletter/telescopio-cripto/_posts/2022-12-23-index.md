    ...
    items:
      ...
      - include: telescopio_v1_balao_01.html
        data:
          ...
          text: >-
            Ho, ho, ho! Esse é nosso último Telescópio antes do Natal e por isso
            já te desejo uma comemoração cheia de paz e luz. ❤️🧑‍🎄🎄❤️ 

            <br />

            Mas a história que você vai ler hoje mais parece um conto de Halloween! 
    ...
    items:
      - include: telescopio_v1_titulo_tracinho.html
        data:
          ...
          text: >
            A exchange de criptomoedas QuadrigaCX foi uma das mais polêmicas e
            controversas do setor de criptomoedas (só perde para a FTX). Fundada
            em 2013 pelo CEO Gerald Cotten, a QuadrigaCX rapidamente se tornou
            uma das principais corretoras de criptomoedas do Canadá. 
            ...
            Sem acesso às carteiras, a QuadrigaCX foi incapaz de pagar as retiradas de fundos solicitadas pelos usuários e declarou falência em janeiro de 2019. 
            ...
            No ano seguinte à falência da QuadrigaCX, um grupo de investigadores forenses foi contratado para tentar rastrear os ativos e determinar o que havia acontecido com os saldos dos usuários. 

            <br />

            De acordo com as investigações, os fundos desaparecidos da QuadrigaCX não estavam realmente perdidos, mas tinham sido utilizados pelo CEO Gerald Cotten para financiar sua vida luxuosa e investir em outros negócios. 

            <br />

            As investigações também descobriram que Cotten operava a QuadrigaCX como um esquema Ponzi, o que significa que ele usava o dinheiro dos novos usuários para pagar os saques dos usuários antigos, mas sem realmente ter os ativos suficientes para fazer isso.
            ...
            A morte suspeita de Cotten e a falência da QuadrigaCX continuam sendo temas de muita especulação e debate na comunidade de criptomoedas. 
            ...
            No final, a verdade sobre o que aconteceu com a QuadrigaCX e os ativos da empresa ainda é um mistério e provavelmente continuará sendo por um tempo.
      - include: telescopio_v1_imagem.html
        data:
      ...
      - include: telescopio_v1_titulo_quadrado_verde.html
        data:
          ...
          text: >
            ...
            Netiflix. Ele se chama “Trust No One: The Hunt for the Crypto King”
            (Não Confie em Ninguém: A Caça ao Rei das Criptomoedas). 
            ...
            No dia 17 de dezembro mais de 100 bitcoins de uma carteira rastreada como possuidora de fundos da QuadrigaCX foram movimentados. 69 BTC foram para uma carteira não-custodial com foco em privacidade e o restante para carteiras aleatórias.

            <br />

            O insano é que esta seria uma carteira considerada com saldo perdido, já que o falecido CEO da corretora,  Gerald Cotten, teria levado as informações das chaves privadas para o túmulo.
            ...
            A - O grupo de investigadores forenses contratado para tentar rastrear os ativos da empresa.<br/>

            B - O co-fundador da exchange, que já tem antiga reputação de ser bem malandrinho.<br/>

            C - O próprio falecido Gerald, seja através de um médium ou de uma ilha paradisíaca bem discreta.<br />
      ...
      - include: telescopio_v1_ad_youtube.html
        data:
          text: >-
            ...
            O que levou essa corretora P2P a eliminar a segunda maior criptomoeda do mundo?
