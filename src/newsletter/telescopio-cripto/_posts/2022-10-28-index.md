      ...
      - include: telescopio_v1_titulo_quadrado_verde.html
        data:
          ...
          text: >-
            ...
            Vimos uma história bem parecida acontecer com os NFTs do protocolo <b>NEAR</b>. Se muitos acreditaram que os projetos migrariam em definitivo para lá, a coisa toda não passou de uma fase apenas. Hoje em dia o volume de negociações de NFTs por lá é sem <b>nenhuma expressão</b>.

            <br />

            Então, somente com o <b>tempo</b> vamos identificar se a Aptos pode tomar espaço real da Solana ou se vemos apenas mais um hype em cima de um projeto que não passará de promessas…
