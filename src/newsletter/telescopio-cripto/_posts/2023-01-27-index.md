      ...
      - include: telescopio_v1_titulo_tracinho.html
        data:
          ...
          text: >
            ...
            touros não tiveram força suficiente para jogar o preço acima da
      ...
      - include: telescopio_v1_paragrafos.html
        data:
          text: >
            ...
            Isso abriu margem para interpretações de que o FED ainda vai precisar ser um pouco mais agressivo na escalada dos juros e que uma recessão americana ainda pode acontecer. Com tudo isso, o Bitcoin ficou nos últimos dias desta semana em uma postura mais lateral nos gráficos de curto prazo, sendo que tal lateralização pode durar até a decisão de juros que acontece na próxima quarta-feira (01/02).
    align: left
  - bg_color: "#fff"
    items:
