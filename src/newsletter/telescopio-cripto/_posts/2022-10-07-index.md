      ...
      - include: telescopio_v1_titulo_tracinho.html
        data:
          ...
          text: >
            ...
            Os estudantes de marketing estudam sobre 5 P’s que mostram quais esforços bem direcionados podem aumentar os lucros e tornar uma empresa uma referência no mercado. 

            <br />

            Vamos vê-los e entender como isso poderia ser usado com projetos blockchain:

            ⚡ <b>Produto</b> - O projeto possui um produto de valor ou é só um token criado sem uma função clara? Cripto para utilizar apenas como dinheiro, já temos o Bitcoin.

            É a boa oferta de um produto que trará os usuários e aumentará a adoção.
  ...
  - bg_color: "#fff"
    items:
      - include: telescopio_v1_titulo_quadrado_verde.html
        data:
          title: "🤔 Uai… Mas ainda tão faltando 5 P’s! 🤔 "
          text: >-
            Os P’s restantes são propostos por Anndy Lian, autor do livro "NFT:
            From Zero to Hero". Segundo ele, devemos acrescentar à lista:

            <br />

            ⏳ <b>Paciência</b> - O Bitcoin não alcançou o preço que tem em poucos meses. A Ethereum está a anos planejando sua versão 2.0. Então, o conceito de “fazer dinheiro fácil e rapidamente” pode não ser tão correto para o mercado cripto. 
      ...
      - include: telescopio_v1_ad_youtube.html
        data:
          text: >-
            ...
            retornos acima de 40% em 30 dias. É possível ver o mesmo em 2022?
            Descubra as ALTCOINS com potencial de explosão no mês.
