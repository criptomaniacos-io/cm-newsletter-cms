    ...
    items:
      - include: telescopio_v1_titulo_tracinho.html
        data:
          ...
          text: >-
            Durante as eleições, talvez a citação mais interessante do então
            candidato à presidência foi o anúncio do registro do seu plano de
            governo em blockchain, sendo a rede escolhida a da Decred. 
            ...
            Entre os nomes dos que poderão ter um importante cargo no governo Lula, temos Henrique Meirelles, que foi o presidente do Banco Central durante os governos do petista, além de ter atuado como Ministro da Fazenda no Governo Michel Temer.

            <br />

            Atualmente, Meirelles atua como conselheiro consultivo da corretora Binance aqui no Brasil.

            <br />

            Um último ponto que seja interessante lembrar é que o Instituto Lula ministrou aulas sobre Bitcoin e NFT. No curso de economia digital da instituição, as tecnologias de criptomoedas faziam parte de um de seus módulos.
            ...
            É que com elas você tem liberdade financeira real e não fica refém de nenhum sistema político.

            <br />

            Entre Lula e Bolsonaro, escolhi o Bitcoin. ❤️
      - include: telescopio_v1_imagem.html
        data:
          text: "\n\n "
          title: btc-love
      ...
      - include: telescopio_v1_titulo_quadrado_verde.html
        data:
          ...
          text: >-
            ...
            por Elon Musk. É responsabilidade da empresa a formação de uma
            equipe para analisar maneiras pelas quais blockchain e criptomoedas
            podem ajudar a plataforma de mídia social. 
            ...
            Um dos problemas a serem enfrentados é a proliferação de contas de bots nos últimos anos. Alguma solução on-chain será idealizada para minimizar o uso de contas fakes no Twitter, que chega a um número tão grande que Musk chegou a tentar cancelar a sua compra.
            ...
            Se Musk já promoveu a memecoin Dogecoin e adicionou-a como forma de pagamento da Tesla, ele removeu o ativo dois meses depois alegando que não era um projeto ambientalmente sustentável.

            <br />

            E, se a Tesla chegou a ter 42 mil Bitcoins, 75% deles foram vendidos nesse ano, mesmo no prejuízo.
  ...
  - bg_color: "#f0f0f0"
    items:
      - include: telescopio_v1_ad_youtube.html
        data:
          text: >-
            A compra do Twitter pelo bilionário Elon Musk mostra que a demanda
            por liberdade cresceu em meio ao ambiente de censura atual. 
