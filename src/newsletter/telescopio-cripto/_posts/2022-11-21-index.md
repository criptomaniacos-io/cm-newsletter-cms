    ...
    items:
      ...
      - include: telescopio_v1_balao_01.html
        data:
          ...
          text: |-
            Difícil não ficar alegre quando a segunda começa com o Telescópio!
            <br />
            Você sabe como funciona a Lightning Network? Vamos aprender?
    ...
    items:
      - include: telescopio_v1_titulo_tracinho.html
        data:
          ...
          text: >-
            Essa é uma semana que podemos esperar volatilidade e uma tomada de
            decisão do BItcoin quanto a sua direção nessa reta final de Novembro
            já que na próxima quarta dia 23/11, veremos a divulgação dos pedidos
            de seguro desemprego nos Estados Unidos. 

            <br />

            Esse dado econômico vai ditar a direção do mercado pois é um indicador para o FED quanto ao arrefecimento da economia americana, sendo que isso sinaliza ou não um maior controle da inflação com a escalada nos juros. Com isso, podemos esperar que até a divulgação desse dado, que o preço do Bitcoin continue em uma posição lateral, conforme estamos vendo agora no gráfico a seguir.
      - include: telescopio_v1_imagem.html
        data:
      ...
      - include: telescopio_v1_paragrafos.html
        data:
          text: >
            ...
            região dos $18.500, sendo que isso é positivo para a renda variável.
            Por outro lado, se os pedidos de seguro desemprego vierem abaixo da
            expectativa, podemos ver o rompimento do suporte em $15.700 e é
            possível uma queda até os 14k.
