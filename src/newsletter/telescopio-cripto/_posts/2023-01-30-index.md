      ...
      - include: telescopio_v1_titulo_tracinho.html
        data:
          ...
          text: >
            ...
            acima da média de 200p no gráfico semanal mesmo com 3 semanas
            seguidas de alta mas rapidamente já voltou a negociar abaixo do
            indicador.

            <br />

            Tal movimento pode impulsionar uma alta mais forte das cotações, porém, não podemos esquecer que a semana está iniciando cheia de dados econômicos relevantes e decisão de juros americana logo no dia 01/02 quarta-feira.

            <br />

            A decisão de juros por parte do FOMC, payroll e pedidos por seguros desemprego tendem a trazer volatilidade para o mercado das cripto moedas, sendo que se qualquer um desses dados vierem com um contexto negativo para a renda variável e ativos de risco, isso pode ser o catalisador de uma correção já iminente para o mercado depois de mais uma semana seguida de alta.

            <br />

            No contexto técnico, é nítido que o Bitcoin está em tendência de alta no curto prazo porém, dentro de uma tendência de baixa no médio e longo prazo, sendo assim, uma correção da tendência de alta poderia acontecer, levando a uma nova formação de fundo ascendente na direção dos suportes marcados no gráfico em amarelo.
      - include: telescopio_v1_imagem.html
        data:
      ...
      - include: telescopio_v1_paragrafos.html
        data:
          text: >-
            ...
            uma semana dominada pela correção, lembrando que isso seria um
            movimento natural de mercado, sem tirar o Bitcoin da tendência de
            alta do curto prazo.


            Para facilitar a visualização de uma correção, marcamos no gráfico com uma linha rosa ($22.700), um nível de gatilho para uma correção do Bitcoin e que enquanto não foi rompido, a tendência é que o preço continue subindo, mesmo que de forma eufórica, podendo buscar os próximos objetivos sinalizados no gráfico com linhas brancas ($25200 e $27.800).
    align: left
  - bg_color: "#fff"
    items:
  ...
  - bg_color: "#f0f0f0"
    items:
      ...
      - include: telescopio_v1_ad_youtube.html
        data:
          text: >-
            Salinas, bilionário mexicano,  afirmou que governos odeiam o
            <b>Bitcoin</b> porque não podem usa-lo para controlar o povo e que
            <b>políticos estão com medo do BTC.</b><br />
             Isto ocorre no momento onde Justin Trudeau, Primeiro Ministro do Canadá faz pronunciamento criticando a maior criptomoeda do mercado... 
