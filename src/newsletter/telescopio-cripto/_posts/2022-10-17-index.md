      ...
      - include: telescopio_v1_titulo_tracinho.html
        data:
          ...
          text: >-
            ...
            A faixa atual de preços é menor do que a de cerca de um mês atrás, quando houve a mudança do consenso de validação da rede.
            ...
            A primeira informação bem relevante é que após o “The Merge”, a queda de emissão de novas moedas é bem perceptível.
      - include: telescopio_v1_imagem.html
        data:
          title: emissão-eth
      ...
      - include: telescopio_v1_paragrafos.html
        data:
          text: >-
            ...
            atualização é de pouco mais de 7 mil unidades. Se a rede ainda
            continuasse com o modelo de validação por prova de trabalho, no
            mesmo período seriam emitidas mais de 388 mil moedas.

            <br />

            Assim, a taxa de inflação anual do novo modelo da rede está em 0,7%. Sem “a fusão”, essa taxa seria de 3,66%.

            <br />

            Em termos de comparação, a taxa de inflação anual do Bitcoin está em 1,72%.

            <br />

            Já dá para vermos que um dos benefícios para a rede com a migração de consenso foi um aumento na escassez de ETH. 

            <br />

            Com o passar dos anos, essa redução de moedas no mercado deve fazer muito bem para o ativo e o colocar num cenário ainda mais positivo para a sua valorização.

            <br />

            Mas beleza… Até agora falamos somente sobre a redução de emissão. Para que a haja deflação entra mais um ponto importante nessa história, que é o burn de moedas.
      - include: telescopio_v1_imagem.html
        data:
          text: "\n\n "
          title: eth-burn
      ...
      - include: telescopio_v1_titulo_quadrado_verde.html
        data:
          ...
          text: >-
            ...
            rede. Chamada de EIP-1559, a proposta queima parte das taxas pagas
            nas transações da Ethereum. Podemos entender por queima, no contexto
            da Ethereum, como remover tokens do fornecimento total.

            <br />

            Então, no caso de uma intensa atividade da rede, podem ser queimadas mais moedas do que se emite.
            ...
            É possível que comecemos a ver essa deflação nos próximos meses de forma consistente, mas existem alguns fatores determinantes para isso:

            <br />

            🔥 A atividade de rede deve ser alta, para que haja um número grande de transações;<br/>

            🔥 O número de nós validadores deve ser equilibrado, já que um número elevado de nodes trás ligeiro aumento de emissão de moedas;<br/>

            🔥 O valor da taxa de transação deve estar numa faixa de preço que leve ao valor queimado impactar de forma significativa. (alta demanda da rede geralmente leva a taxa da transação para cima)

            <br />

            Também é válido pensar que a rede pode no futuro alternar entre períodos de inflação e deflação, de acordo com o que acontece com as variáveis acima.
  ...
  - bg_color: "#f0f0f0"
    items:
      - include: telescopio_v1_ad_youtube.html
        data:
          text: >-
            Era uma vez 3 Porquinhos: Minion, Faria Limer e Stack. Stack
            ...
            energias em reforçar suas casas. Mal sabiam eles que o Lula mal se
