          ...
          text: >
            ...
            <div style="text-align: center;">
              <a href="https://meugrupo.vip/c/26473" target="_blank">
                <button style="background-color: limegreen; color: white; border: 1px solid white; box-shadow: 2px 2px 2px grey; padding: 10px 20px; cursor: pointer; font-size: 16px;" onmouseover="this.style.backgroundColor='limegreen'">
                  Clique aqui
                </button>
              </a>
            </div>
